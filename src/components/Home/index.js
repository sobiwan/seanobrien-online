...
import Forbes from "../../resources/imgaes/30under30.png";
import "./home.css";
          ...
          <div className="left-sticky-content-container">
            ...
            <div className="left-sticky-blurb-container">
              <div className="blurb-text">
                ...
                issue{" "}
                <a href={mavelyUrl} target="_blank">
                  @Mavely
                </a>
                . Formerly co-created the world's first
                emoji ad network{" "}
                <a href={swyftUrl} target="_blank">
                  @Swyft
                </a>{" "}
                and took a culure first approach to
                resturant roll ups{" "}
                <a href={irishbeefURL} target="_blank">
                  @IrishBeef
                </a>
                . Follow my work, interest and
